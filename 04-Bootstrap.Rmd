...
This was a study on in-hospital deaths from mayocardial infarction with ST elevation (STEMI) which was done in Oregon.  Summary stats of the study is as follows:


- 9  hospitals in the Providence Health system in Oregon.
- Study period : from 2002 to 2003.
- 913  STEMI patients treated, of whom 105 died (in-hospital deaths) from mayocardial infarction with ST elevation (STEMI). 
- Each patient was assigned a Thrombosis in Mayocardial Infarction Risk Scores
...
mydata <- read.csv('https://academics.hamilton.edu/mathematics/ckuruwit/Data/MIdata.csv')
