...
large_data <- read.csv(file = 'https://raw.githubusercontent.com/gitcnk/Data/master/very_large_sample.csv')

```

\
As the following plot shows the two samples are almost identical both in shape and spread.  Both samples have almost the same mean and median.
...
mydata <- read.csv(file = 'https://raw.githubusercontent.com/gitcnk/Data/master/FlightDelays2017.csv')
